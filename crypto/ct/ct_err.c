...
static const ERR_STRING_DATA CT_str_functs[] = {
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_NEW, 0), "VR_CTLOG_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_NEW_FROM_BASE64, 0),
     "VR_CTLOG_new_from_base64"},
    ...
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_STORE_LOAD_FILE, 0),
     "VR_CTLOG_STORE_load_file"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_STORE_LOAD_LOG, 0),
     "ctlog_store_load_log"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CTLOG_STORE_NEW, 0), "VR_CTLOG_STORE_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CT_BASE64_DECODE, 0), "ct_base64_decode"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CT_POLICY_EVAL_CTX_NEW, 0),
     "VR_CT_POLICY_EVAL_CTX_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_CT_V1_LOG_ID_FROM_PKEY, 0),
     "ct_v1_log_id_from_pkey"},
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT, 0), "VR_i2o_SCT"},
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT_LIST, 0), "VR_i2o_SCT_LIST"},
    {ERR_PACK(ERR_LIB_CT, CT_F_I2O_SCT_SIGNATURE, 0), "VR_i2o_SCT_signature"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT, 0), "VR_o2i_SCT"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT_LIST, 0), "VR_o2i_SCT_LIST"},
    {ERR_PACK(ERR_LIB_CT, CT_F_O2I_SCT_SIGNATURE, 0), "VR_o2i_SCT_signature"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_CTX_NEW, 0), "VR_SCT_CTX_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_CTX_VERIFY, 0), "VR_SCT_CTX_verify"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_NEW, 0), "VR_SCT_new"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_NEW_FROM_BASE64, 0), "VR_SCT_new_from_base64"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET0_LOG_ID, 0), "VR_SCT_set0_log_id"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET1_EXTENSIONS, 0), "VR_SCT_set1_extensions"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET1_LOG_ID, 0), "VR_SCT_set1_log_id"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET1_SIGNATURE, 0), "VR_SCT_set1_signature"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET_LOG_ENTRY_TYPE, 0),
     "VR_SCT_set_log_entry_type"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET_SIGNATURE_NID, 0),
     "VR_SCT_set_signature_nid"},
    {ERR_PACK(ERR_LIB_CT, CT_F_SCT_SET_VERSION, 0), "VR_SCT_set_version"},
    {0, NULL}
};
...
int VR_ERR_load_CT_strings(void)
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(CT_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(CT_str_functs);
        VR_ERR_load_strings_const(CT_str_reasons);
    }
#endif
    return 1;
}
