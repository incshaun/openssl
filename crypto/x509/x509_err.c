...
static const ERR_STRING_DATA X509_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_X509, X509_F_GET_CERT_BY_SUBJECT, 0),
     "get_cert_by_subject"},
    {ERR_PACK(ERR_LIB_X509, X509_F_I2D_X509_AUX, 0), "VR_i2d_X509_AUX"},
    {ERR_PACK(ERR_LIB_X509, X509_F_LOOKUP_CERTS_SK, 0), "lookup_certs_sk"},
    {ERR_PACK(ERR_LIB_X509, X509_F_NETSCAPE_SPKI_B64_DECODE, 0),
     "VR_NETSCAPE_SPKI_b64_decode"},
    {ERR_PACK(ERR_LIB_X509, X509_F_NETSCAPE_SPKI_B64_ENCODE, 0),
     "VR_NETSCAPE_SPKI_b64_encode"},
    {ERR_PACK(ERR_LIB_X509, X509_F_NEW_DIR, 0), "new_dir"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509AT_ADD1_ATTR, 0), "VR_X509at_add1_attr"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509V3_ADD_EXT, 0), "VR_X509v3_add_ext"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_ATTRIBUTE_CREATE_BY_NID, 0),
     "VR_X509_ATTRIBUTE_create_by_NID"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_ATTRIBUTE_CREATE_BY_OBJ, 0),
     "VR_X509_ATTRIBUTE_create_by_OBJ"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_ATTRIBUTE_CREATE_BY_TXT, 0),
     "VR_X509_ATTRIBUTE_create_by_txt"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_ATTRIBUTE_GET0_DATA, 0),
     "VR_X509_ATTRIBUTE_get0_data"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_ATTRIBUTE_SET1_DATA, 0),
     "VR_X509_ATTRIBUTE_set1_data"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_CHECK_PRIVATE_KEY, 0),
     "VR_X509_check_private_key"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_CRL_DIFF, 0), "VR_X509_CRL_diff"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_CRL_METHOD_NEW, 0),
     "VR_X509_CRL_METHOD_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_CRL_PRINT_FP, 0), "VR_X509_CRL_print_fp"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_EXTENSION_CREATE_BY_NID, 0),
     "VR_X509_EXTENSION_create_by_NID"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_EXTENSION_CREATE_BY_OBJ, 0),
     "VR_X509_EXTENSION_create_by_OBJ"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_GET_PUBKEY_PARAMETERS, 0),
     "VR_X509_get_pubkey_parameters"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_LOAD_CERT_CRL_FILE, 0),
     "VR_X509_load_cert_crl_file"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_LOAD_CERT_FILE, 0),
     "VR_X509_load_cert_file"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_LOAD_CRL_FILE, 0),
     "VR_X509_load_crl_file"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_LOOKUP_METH_NEW, 0),
     "VR_X509_LOOKUP_meth_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_LOOKUP_NEW, 0), "VR_X509_LOOKUP_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_ADD_ENTRY, 0),
     "VR_X509_NAME_add_entry"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_CANON, 0), "VR_x509_name_canon"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_ENTRY_CREATE_BY_NID, 0),
     "VR_X509_NAME_ENTRY_create_by_NID"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_ENTRY_CREATE_BY_TXT, 0),
     "VR_X509_NAME_ENTRY_create_by_txt"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_ENTRY_SET_OBJECT, 0),
     "VR_X509_NAME_ENTRY_set_object"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_ONELINE, 0), "VR_X509_NAME_oneline"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_NAME_PRINT, 0), "VR_X509_NAME_print"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_OBJECT_NEW, 0), "VR_X509_OBJECT_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_PRINT_EX_FP, 0), "VR_X509_print_ex_fp"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_PUBKEY_DECODE, 0),
     "VR_x509_pubkey_decode"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_PUBKEY_GET0, 0), "VR_X509_PUBKEY_get0"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_PUBKEY_SET, 0), "VR_X509_PUBKEY_set"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_REQ_CHECK_PRIVATE_KEY, 0),
     "VR_X509_REQ_check_private_key"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_REQ_PRINT_EX, 0), "VR_X509_REQ_print_ex"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_REQ_PRINT_FP, 0), "VR_X509_REQ_print_fp"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_REQ_TO_X509, 0), "VR_X509_REQ_to_X509"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_ADD_CERT, 0),
     "VR_X509_STORE_add_cert"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_ADD_CRL, 0),
     "VR_X509_STORE_add_crl"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_ADD_LOOKUP, 0),
     "VR_X509_STORE_add_lookup"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_CTX_GET1_ISSUER, 0),
     "VR_X509_STORE_CTX_get1_issuer"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_CTX_INIT, 0),
     "VR_X509_STORE_CTX_init"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_CTX_NEW, 0),
     "VR_X509_STORE_CTX_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_CTX_PURPOSE_INHERIT, 0),
     "VR_X509_STORE_CTX_purpose_inherit"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_STORE_NEW, 0), "VR_X509_STORE_new"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_TO_X509_REQ, 0), "VR_X509_to_X509_REQ"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_TRUST_ADD, 0), "VR_X509_TRUST_add"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_TRUST_SET, 0), "VR_X509_TRUST_set"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_VERIFY_CERT, 0), "VR_X509_verify_cert"},
    {ERR_PACK(ERR_LIB_X509, X509_F_X509_VERIFY_PARAM_NEW, 0),
     "VR_X509_VERIFY_PARAM_new"},
    {0, NULL}
};
...
int VR_ERR_load_X509_strings(void)
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(X509_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(X509_str_functs);
        VR_ERR_load_strings_const(X509_str_reasons);
    }
#endif
    return 1;
}
