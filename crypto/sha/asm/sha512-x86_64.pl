...
$code.=<<___;
.type	VR_sha256_block_data_order_shaext,\@function,3
.align	64
VR_sha256_block_data_order_shaext:
_shaext_shortcut:
___
$code.=<<___ if ($win64);
	lea	`-8-5*16`(%rsp),%rsp
...
$code.=<<___;
	ret
.size	VR_sha256_block_data_order_shaext,.-VR_sha256_block_data_order_shaext
___
}}}
{{{
