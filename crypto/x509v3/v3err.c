...
static const ERR_STRING_DATA X509V3_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_POLICY_CACHE_NEW, 0),
     "policy_cache_new"},
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_POLICY_DATA_NEW, 0), "VR_policy_data_new"},
...
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(X509V3_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(X509V3_str_functs);
        VR_ERR_load_strings_const(X509V3_str_reasons);
    }
#endif
    return 1;
}
