...
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(OSSL_STORE_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(OSSL_STORE_str_functs);
        VR_ERR_load_strings_const(OSSL_STORE_str_reasons);
    }
#endif
    return 1;
}
