...
static const ERR_STRING_DATA CMS_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DATA, 0), "VR_CMS_data"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DATAFINAL, 0), "VR_CMS_dataFinal"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DATAINIT, 0), "VR_CMS_dataInit"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DECRYPT, 0), "VR_CMS_decrypt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DECRYPT_SET1_KEY, 0),
     "VR_CMS_decrypt_set1_key"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DECRYPT_SET1_PASSWORD, 0),
     "VR_CMS_decrypt_set1_password"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DECRYPT_SET1_PKEY, 0),
     "VR_CMS_decrypt_set1_pkey"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DIGESTALGORITHM_FIND_CTX, 0),
     "VR_cms_DigestAlgorithm_find_ctx"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DIGESTALGORITHM_INIT_BIO, 0),
     "VR_cms_DigestAlgorithm_init_bio"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DIGESTEDDATA_DO_FINAL, 0),
     "VR_cms_DigestedData_do_final"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_DIGEST_VERIFY, 0), "VR_CMS_digest_verify"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCODE_RECEIPT, 0), "VR_cms_encode_Receipt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPT, 0), "VR_CMS_encrypt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPTEDCONTENT_INIT, 0),
     "VR_cms_EncryptedContent_init"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPTEDCONTENT_INIT_BIO, 0),
     "VR_cms_EncryptedContent_init_bio"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPTEDDATA_DECRYPT, 0),
     "VR_CMS_EncryptedData_decrypt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPTEDDATA_ENCRYPT, 0),
     "VR_CMS_EncryptedData_encrypt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENCRYPTEDDATA_SET1_KEY, 0),
     "VR_CMS_EncryptedData_set1_key"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENVELOPEDDATA_CREATE, 0),
     "VR_CMS_EnvelopedData_create"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENVELOPEDDATA_INIT_BIO, 0),
     "VR_cms_EnvelopedData_init_bio"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENVELOPED_DATA_INIT, 0),
     "cms_enveloped_data_init"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_ENV_ASN1_CTRL, 0), "VR_cms_env_asn1_ctrl"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_FINAL, 0), "VR_CMS_final"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET0_CERTIFICATE_CHOICES, 0),
     "cms_get0_certificate_choices"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET0_CONTENT, 0), "VR_CMS_get0_content"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET0_ECONTENT_TYPE, 0),
     "cms_get0_econtent_type"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_GET0_ENVELOPED, 0), "VR_cms_get0_enveloped"},
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_KTRI_GET0_ALGS, 0),
     "VR_CMS_RecipientInfo_ktri_get0_algs"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_KTRI_GET0_SIGNER_ID, 0),
     "VR_CMS_RecipientInfo_ktri_get0_signer_id"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_PWRI_CRYPT, 0),
     "VR_cms_RecipientInfo_pwri_crypt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_SET0_KEY, 0),
     "VR_CMS_RecipientInfo_set0_key"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_SET0_PASSWORD, 0),
     "VR_CMS_RecipientInfo_set0_password"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_RECIPIENTINFO_SET0_PKEY, 0),
     "VR_CMS_RecipientInfo_set0_pkey"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SD_ASN1_CTRL, 0), "cms_sd_asn1_ctrl"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SET1_IAS, 0), "VR_cms_set1_ias"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SET1_KEYID, 0), "VR_cms_set1_keyid"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SET1_SIGNERIDENTIFIER, 0),
     "VR_cms_set1_SignerIdentifier"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SET_DETACHED, 0), "VR_CMS_set_detached"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGN, 0), "VR_CMS_sign"},
    ...
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGNERINFO_SIGN, 0),
     "VR_CMS_SignerInfo_sign"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGNERINFO_VERIFY, 0),
     "VR_CMS_SignerInfo_verify"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGNERINFO_VERIFY_CERT, 0),
     "cms_signerinfo_verify_cert"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGNERINFO_VERIFY_CONTENT, 0),
     "VR_CMS_SignerInfo_verify_content"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_SIGN_RECEIPT, 0), "VR_CMS_sign_receipt"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_STREAM, 0), "VR_CMS_stream"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_UNCOMPRESS, 0), "VR_CMS_uncompress"},
    {ERR_PACK(ERR_LIB_CMS, CMS_F_CMS_VERIFY, 0), "VR_CMS_verify"},
...
int VR_ERR_load_CMS_strings(void)
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(CMS_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(CMS_str_functs);
        VR_ERR_load_strings_const(CMS_str_reasons);
    }
#endif
    return 1;
}
