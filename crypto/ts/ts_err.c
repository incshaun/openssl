...
static const ERR_STRING_DATA TS_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_CONF_LOAD_CERT, 0), "VR_TS_CONF_load_cert"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_CONF_LOAD_CERTS, 0), "VR_TS_CONF_load_certs"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_CONF_LOAD_KEY, 0), "VR_TS_CONF_load_key"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_CONF_LOOKUP_FAIL, 0), "ts_CONF_lookup_fail"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_CONF_SET_DEFAULT_ENGINE, 0),
     "VR_TS_CONF_set_default_engine"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_GET_STATUS_TEXT, 0), "ts_get_status_text"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_MSG_IMPRINT_SET_ALGO, 0),
     "VR_TS_MSG_IMPRINT_set_algo"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_REQ_SET_MSG_IMPRINT, 0),
     "VR_TS_REQ_set_msg_imprint"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_REQ_SET_NONCE, 0), "VR_TS_REQ_set_nonce"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_REQ_SET_POLICY_ID, 0),
     "VR_TS_REQ_set_policy_id"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CREATE_RESPONSE, 0),
     "VR_TS_RESP_create_response"},
    ...
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_ADD_FAILURE_INFO, 0),
     "VR_TS_RESP_CTX_add_failure_info"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_ADD_MD, 0), "VR_TS_RESP_CTX_add_md"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_ADD_POLICY, 0),
     "VR_TS_RESP_CTX_add_policy"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_NEW, 0), "VR_TS_RESP_CTX_new"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_SET_ACCURACY, 0),
     "VR_TS_RESP_CTX_set_accuracy"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_SET_CERTS, 0),
     "VR_TS_RESP_CTX_set_certs"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_SET_DEF_POLICY, 0),
     "VR_TS_RESP_CTX_set_def_policy"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_SET_SIGNER_CERT, 0),
     "VR_TS_RESP_CTX_set_signer_cert"},
    {ERR_PACK(ERR_LIB_TS, TS_F_TS_RESP_CTX_SET_STATUS_INFO, 0),
     "VR_TS_RESP_CTX_set_status_info"},
...
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(TS_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(TS_str_functs);
        VR_ERR_load_strings_const(TS_str_reasons);
    }
#endif
    return 1;
}
