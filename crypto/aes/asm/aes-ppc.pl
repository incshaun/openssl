...
# counterparts are, for security reason. ppc_VR_AES_encrypt_compact runs
# at 1/2 of ppc_VR_AES_encrypt speed, while ppc_VR_AES_decrypt_compact -
# at 1/3 of ppc_VR_AES_decrypt.
...
# ppc_VR_AES_encrypt_compact operates at 42 cycles per byte, while
# ppc_VR_AES_decrypt_compact - at 55 (in 64-bit build).
...
$code.=<<___;
	bl	LAES_Te
	bl	Lppc_VR_AES_encrypt_compact
...
$code.=<<___;
	bl	LAES_Td
	bl	Lppc_VR_AES_decrypt_compact
	$POP	$out,`$FRAME-$SIZE_T*19`($sp)
___
$code.=<<___ if ($LITTLE_ENDIAN);
	rotlwi	$t0,$s0,8
