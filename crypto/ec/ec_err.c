...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPARAMETERS, 0), "VR_d2i_ECParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPKPARAMETERS, 0), "VR_d2i_ECPKParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_D2I_ECPRIVATEKEY, 0), "VR_d2i_ECPrivateKey"},
    {ERR_PACK(ERR_LIB_EC, EC_F_DO_EC_KEY_PRINT, 0), "do_VR_EC_KEY_print"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDH_COMPUTE_KEY, 0), "VR_ECDH_compute_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDH_SIMPLE_COMPUTE_KEY, 0),
     "VR_ecdh_simple_compute_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_DO_SIGN_EX, 0), "VR_ECDSA_do_sign_ex"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_DO_VERIFY, 0), "VR_ECDSA_do_verify"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIGN_EX, 0), "VR_ECDSA_sign_ex"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIGN_SETUP, 0), "VR_ECDSA_sign_setup"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_SIG_NEW, 0), "VR_ECDSA_SIG_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_ECDSA_VERIFY, 0), "VR_ECDSA_verify"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GF2M_SIMPLE_OCT2POINT, 0),
     "VR_ec_GF2m_simple_oct2point"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GF2M_SIMPLE_POINT2OCT, 0),
     "VR_ec_GF2m_simple_point2oct"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GF2M_SIMPLE_SET_COMPRESSED_COORDINATES, 0),
     "VR_ec_GF2m_simple_set_compressed_coordinates"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GFP_SIMPLE_OCT2POINT, 0),
     "VR_ec_GFp_simple_oct2point"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GFP_SIMPLE_POINT2OCT, 0),
     "VR_ec_GFp_simple_point2oct"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GFP_SIMPLE_SET_COMPRESSED_COORDINATES, 0),
     "VR_ec_GFp_simple_set_compressed_coordinates"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_CHECK, 0), "VR_EC_GROUP_check"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_CHECK_DISCRIMINANT, 0),
     "VR_EC_GROUP_check_discriminant"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_COPY, 0), "VR_EC_GROUP_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_CURVE, 0), "VR_EC_GROUP_get_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_CURVE_GF2M, 0),
     "VR_EC_GROUP_get_curve_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_CURVE_GFP, 0),
     "VR_EC_GROUP_get_curve_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_DEGREE, 0), "VR_EC_GROUP_get_degree"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_ECPARAMETERS, 0),
     "VR_EC_GROUP_get_ecparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_ECPKPARAMETERS, 0),
     "VR_EC_GROUP_get_ecpkparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_PENTANOMIAL_BASIS, 0),
     "VR_EC_GROUP_get_pentanomial_basis"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_GET_TRINOMIAL_BASIS, 0),
     "VR_EC_GROUP_get_trinomial_basis"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_NEW, 0), "VR_EC_GROUP_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_NEW_BY_CURVE_NAME, 0),
     "VR_EC_GROUP_new_by_curve_name"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_NEW_FROM_ECPARAMETERS, 0),
     "VR_EC_GROUP_new_from_ecparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_NEW_FROM_ECPKPARAMETERS, 0),
     "VR_EC_GROUP_new_from_ecpkparameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_CURVE, 0), "VR_EC_GROUP_set_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_CURVE_GF2M, 0),
     "VR_EC_GROUP_set_curve_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_CURVE_GFP, 0),
     "VR_EC_GROUP_set_curve_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_GENERATOR, 0),
     "VR_EC_GROUP_set_generator"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_GROUP_SET_SEED, 0), "VR_EC_GROUP_set_seed"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_CHECK_KEY, 0), "VR_EC_KEY_check_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_COPY, 0), "VR_EC_KEY_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_GENERATE_KEY, 0), "VR_EC_KEY_generate_key"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_NEW, 0), "VR_EC_KEY_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_NEW_METHOD, 0), "VR_EC_KEY_new_method"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_OCT2PRIV, 0), "VR_EC_KEY_oct2priv"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRINT, 0), "VR_EC_KEY_print"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRINT_FP, 0), "VR_EC_KEY_print_fp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRIV2BUF, 0), "VR_EC_KEY_priv2buf"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_PRIV2OCT, 0), "VR_EC_KEY_priv2oct"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_KEY_SET_PUBLIC_KEY_AFFINE_COORDINATES, 0),
     "VR_EC_KEY_set_public_key_affine_coordinates"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_MAKE_AFFINE, 0),
     "VR_EC_POINTs_make_affine"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINTS_MUL, 0), "VR_EC_POINTs_mul"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_ADD, 0), "VR_EC_POINT_add"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_BN2POINT, 0), "VR_EC_POINT_bn2point"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_CMP, 0), "VR_EC_POINT_cmp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_COPY, 0), "VR_EC_POINT_copy"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_DBL, 0), "VR_EC_POINT_dbl"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_GET_AFFINE_COORDINATES_GF2M, 0),
     "VR_EC_POINT_get_affine_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_GET_AFFINE_COORDINATES_GFP, 0),
     "VR_EC_POINT_get_affine_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_GET_JPROJECTIVE_COORDINATES_GFP, 0),
     "VR_EC_POINT_get_Jprojective_coordinates_GFp"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_INVERT, 0), "VR_EC_POINT_invert"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_IS_AT_INFINITY, 0),
     "VR_EC_POINT_is_at_infinity"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_IS_ON_CURVE, 0),
     "VR_EC_POINT_is_on_curve"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_MAKE_AFFINE, 0),
     "VR_EC_POINT_make_affine"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_NEW, 0), "VR_EC_POINT_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_OCT2POINT, 0), "VR_EC_POINT_oct2point"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_POINT2BUF, 0), "VR_EC_POINT_point2buf"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_POINT2OCT, 0), "VR_EC_POINT_point2oct"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_SET_AFFINE_COORDINATES_GF2M, 0),
     "VR_EC_POINT_set_affine_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_SET_AFFINE_COORDINATES_GFP, 0),
     "VR_EC_POINT_set_affine_coordinates_GFp"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_SET_COMPRESSED_COORDINATES_GF2M, 0),
     "VR_EC_POINT_set_compressed_coordinates_GF2m"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_SET_COMPRESSED_COORDINATES_GFP, 0),
     "VR_EC_POINT_set_compressed_coordinates_GFp"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_POINT_SET_TO_INFINITY, 0),
     "VR_EC_POINT_set_to_infinity"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_PRE_COMP_NEW, 0), "ec_pre_comp_new"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_SCALAR_MUL_LADDER, 0),
     "VR_ec_scalar_mul_ladder"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_WNAF_MUL, 0), "VR_ec_wNAF_mul"},
    {ERR_PACK(ERR_LIB_EC, EC_F_EC_WNAF_PRECOMPUTE_MULT, 0),
     "VR_ec_wNAF_precompute_mult"},
    {ERR_PACK(ERR_LIB_EC, EC_F_I2D_ECPARAMETERS, 0), "VR_i2d_ECParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_I2D_ECPKPARAMETERS, 0), "VR_i2d_ECPKParameters"},
    {ERR_PACK(ERR_LIB_EC, EC_F_I2D_ECPRIVATEKEY, 0), "VR_i2d_ECPrivateKey"},
    {ERR_PACK(ERR_LIB_EC, EC_F_I2O_ECPUBLICKEY, 0), "VR_i2o_ECPublicKey"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_O2I_ECPUBLICKEY, 0), "VR_o2i_ECPublicKey"},
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_OSSL_ECDSA_SIGN_SIG, 0), "VR_ossl_ecdsa_sign_sig"},
...
int VR_ERR_load_EC_strings(void)
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(EC_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(EC_str_functs);
        VR_ERR_load_strings_const(EC_str_reasons);
    }
#endif
    return 1;
}
