...
void VR_gf_mul(gf_s * RESTRICT cs, const gf as, const gf bs)
{
...
void VR_gf_mulw_unsigned(gf_s * RESTRICT cs, const gf as, uint32_t b)
{
...
void VR_gf_sqr(gf_s * RESTRICT cs, const gf as)
{
    VR_gf_mul(cs, as, as);         /* Performs better with a dedicated square */
}
