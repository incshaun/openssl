...
static const ERR_STRING_DATA PKCS7_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD0_ATTRIB_SIGNING_TIME, 0),
     "VR_PKCS7_add0_attrib_signing_time"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_ATTRIB_SMIMECAP, 0),
     "VR_PKCS7_add_attrib_smimecap"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_CERTIFICATE, 0),
     "VR_PKCS7_add_certificate"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_CRL, 0), "VR_PKCS7_add_crl"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_RECIPIENT_INFO, 0),
     "VR_PKCS7_add_recipient_info"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_SIGNATURE, 0),
     "VR_PKCS7_add_signature"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ADD_SIGNER, 0), "VR_PKCS7_add_signer"},
    ...
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_CTRL, 0), "VR_PKCS7_ctrl"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATADECODE, 0), "VR_PKCS7_dataDecode"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAFINAL, 0), "VR_PKCS7_dataFinal"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAINIT, 0), "VR_PKCS7_dataInit"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DATAVERIFY, 0), "VR_PKCS7_dataVerify"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DECRYPT, 0), "VR_PKCS7_decrypt"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_DECRYPT_RINFO, 0),
     "pkcs7_decrypt_rinfo"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ENCODE_RINFO, 0),
     "pkcs7_encode_rinfo"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_ENCRYPT, 0), "VR_PKCS7_encrypt"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_FINAL, 0), "VR_PKCS7_final"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_FIND_DIGEST, 0),
     "PKCS7_find_digest"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_GET0_SIGNERS, 0),
     "VR_PKCS7_get0_signers"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_RECIP_INFO_SET, 0),
     "VR_PKCS7_RECIP_INFO_set"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_CIPHER, 0), "VR_PKCS7_set_cipher"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_CONTENT, 0),
     "VR_PKCS7_set_content"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_DIGEST, 0), "VR_PKCS7_set_digest"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SET_TYPE, 0), "VR_PKCS7_set_type"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGN, 0), "VR_PKCS7_sign"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGNATUREVERIFY, 0),
     "VR_PKCS7_signatureVerify"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGNER_INFO_SET, 0),
     "VR_PKCS7_SIGNER_INFO_set"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGNER_INFO_SIGN, 0),
     "VR_PKCS7_SIGNER_INFO_sign"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIGN_ADD_SIGNER, 0),
     "VR_PKCS7_sign_add_signer"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_SIMPLE_SMIMECAP, 0),
     "VR_PKCS7_simple_smimecap"},
    {ERR_PACK(ERR_LIB_PKCS7, PKCS7_F_PKCS7_VERIFY, 0), "VR_PKCS7_verify"},
    {0, NULL}
};
...
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(PKCS7_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(PKCS7_str_functs);
        VR_ERR_load_strings_const(PKCS7_str_reasons);
    }
#endif
    return 1;
}
