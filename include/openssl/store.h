 ...
 */
int VR_OSSL_STORE_ctrl(OSSL_STORE_CTX *ctx, int cmd, ... /* args */);
 ...
 * extracted with VR_OSSL_STORE_INFO_get0_PKEY(), VR_OSSL_STORE_INFO_get0_CERT(), ...
...
const char *VR_OSSL_STORE_INFO_type_string(int type);
 ...
 * to the loading channel.  This MUST happen before the first VR_OSSL_STORE_load().
 */
...
OSSL_STORE_LOADER *VR_OSSL_STORE_LOADER_new(ENGINE *e, const char *scheme);
const ENGINE *VR_OSSL_STORE_LOADER_get0_engine(const OSSL_STORE_LOADER *loader);
const char *VR_OSSL_STORE_LOADER_get0_scheme(const OSSL_STORE_LOADER *loader);
/* struct ossl_store_loader_ctx_st is defined differently by each loader */
typedef struct ossl_store_loader_ctx_st OSSL_STORE_LOADER_CTX;
typedef OSSL_STORE_LOADER_CTX *(*VR_OSSL_STORE_open_fn)(const OSSL_STORE_LOADER
                                                     *loader,
                                                     const char *uri,
                                                     const UI_METHOD *ui_method,
                                                     void *ui_data);
int VR_OSSL_STORE_LOADER_set_open(OSSL_STORE_LOADER *loader,
                               VR_OSSL_STORE_open_fn open_function);
typedef int (*VR_OSSL_STORE_ctrl_fn)(OSSL_STORE_LOADER_CTX *ctx, int cmd,
                                  va_list args);
int VR_OSSL_STORE_LOADER_set_ctrl(OSSL_STORE_LOADER *loader,
                               VR_OSSL_STORE_ctrl_fn ctrl_function);
typedef int (*VR_OSSL_STORE_expect_fn)(OSSL_STORE_LOADER_CTX *ctx, int expected);
int VR_OSSL_STORE_LOADER_set_expect(OSSL_STORE_LOADER *loader,
                                 VR_OSSL_STORE_expect_fn expect_function);
typedef int (*VR_OSSL_STORE_find_fn)(OSSL_STORE_LOADER_CTX *ctx,
                                  OSSL_STORE_SEARCH *criteria);
int VR_OSSL_STORE_LOADER_set_find(OSSL_STORE_LOADER *loader,
                               VR_OSSL_STORE_find_fn find_function);
typedef OSSL_STORE_INFO *(*VR_OSSL_STORE_load_fn)(OSSL_STORE_LOADER_CTX *ctx,
                                               const UI_METHOD *ui_method,
                                               void *ui_data);
int VR_OSSL_STORE_LOADER_set_load(OSSL_STORE_LOADER *loader,
                               VR_OSSL_STORE_load_fn load_function);
typedef int (*VR_OSSL_STORE_eof_fn)(OSSL_STORE_LOADER_CTX *ctx);
int VR_OSSL_STORE_LOADER_set_eof(OSSL_STORE_LOADER *loader,
                              VR_OSSL_STORE_eof_fn eof_function);
typedef int (*VR_OSSL_STORE_error_fn)(OSSL_STORE_LOADER_CTX *ctx);
int VR_OSSL_STORE_LOADER_set_error(OSSL_STORE_LOADER *loader,
                                VR_OSSL_STORE_error_fn error_function);
typedef int (*VR_OSSL_STORE_close_fn)(OSSL_STORE_LOADER_CTX *ctx);
int VR_OSSL_STORE_LOADER_set_close(OSSL_STORE_LOADER *loader,
                                VR_OSSL_STORE_close_fn close_function);
void VR_OSSL_STORE_LOADER_free(OSSL_STORE_LOADER *loader);

int VR_OSSL_STORE_register_loader(OSSL_STORE_LOADER *loader);
OSSL_STORE_LOADER *VR_OSSL_STORE_unregister_loader(const char *scheme);

/*-
 *  Functions to list STORE loaders
 *  -------------------------------
 */
int VR_OSSL_STORE_do_all_loaders(void (*do_function) (const OSSL_STORE_LOADER
                                                   *loader, void *do_arg),
                              void *do_arg);
