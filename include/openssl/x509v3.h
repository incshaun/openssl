...
# define X509V3_conf_err(val) VR_ERR_add_error_data(6, \
                        "section:", (val)->section, \
                        ",name:", (val)->name, ",value:", (val)->value)

# define VR_X509V3_set_ctx_test(ctx) \
                        VR_X509V3_set_ctx(ctx, NULL, NULL, NULL, NULL, CTX_TEST)
# define VR_X509V3_set_ctx_nodb(ctx) (ctx)->db = NULL;

# define EXT_BITSTRING(nid, table) { nid, 0, ASN1_ITEM_ref(ASN1_BIT_STRING), \
                        0,0,0,0, \
                        0,0, \
                        (X509V3_EXT_I2V)VR_i2v_ASN1_BIT_STRING, \
                        (X509V3_EXT_V2I)VR_v2i_ASN1_BIT_STRING, \
                        NULL, NULL, \
                        table}

# define EXT_IA5STRING(nid) { nid, 0, ASN1_ITEM_ref(ASN1_IA5STRING), \
                        0,0,0,0, \
                        (X509V3_EXT_I2S)VR_i2s_ASN1_IA5STRING, \
                        (X509V3_EXT_S2I)VR_s2i_ASN1_IA5STRING, \
                        0,0,0,0, \
                        NULL}
...
int VR_SXNET_add_id_ulong(SXNET **psx, unsigned long lzone, const char *user,
                       int userlen);
int VR_SXNET_add_id_INTEGER(SXNET **psx, ASN1_INTEGER *izone, const char *user,
                         int userlen);
...
ASN1_BIT_STRING *VR_v2i_ASN1_BIT_STRING(X509V3_EXT_METHOD *method,
                                     X509V3_CTX *ctx,
                                     STACK_OF(CONF_VALUE) *nval);
STACK_OF(CONF_VALUE) *VR_i2v_ASN1_BIT_STRING(X509V3_EXT_METHOD *method,
                                          ASN1_BIT_STRING *bits,
                                          STACK_OF(CONF_VALUE) *extlist);
char *VR_i2s_ASN1_IA5STRING(X509V3_EXT_METHOD *method, ASN1_IA5STRING *ia5);
ASN1_IA5STRING *VR_s2i_ASN1_IA5STRING(X509V3_EXT_METHOD *method,
                                   X509V3_CTX *ctx, const char *str);

STACK_OF(CONF_VALUE) *VR_i2v_GENERAL_NAME(X509V3_EXT_METHOD *method,
                                       GENERAL_NAME *gen,
                                       STACK_OF(CONF_VALUE) *ret);
int VR_GENERAL_NAME_print(BIO *out, GENERAL_NAME *gen);

DECLARE_ASN1_FUNCTIONS(GENERAL_NAMES)

STACK_OF(CONF_VALUE) *VR_i2v_GENERAL_NAMES(X509V3_EXT_METHOD *method,
                                        GENERAL_NAMES *gen,
                                        STACK_OF(CONF_VALUE) *extlist);
GENERAL_NAMES *VR_v2i_GENERAL_NAMES(const X509V3_EXT_METHOD *method,
...
char *VR_i2s_ASN1_OCTET_STRING(X509V3_EXT_METHOD *method,
                            const ASN1_OCTET_STRING *ia5);
ASN1_OCTET_STRING *VR_s2i_ASN1_OCTET_STRING(X509V3_EXT_METHOD *method,
                                         X509V3_CTX *ctx, const char *str);
...
GENERAL_NAME *VR_a2i_GENERAL_NAME(GENERAL_NAME *out,
                               const X509V3_EXT_METHOD *method,
                               X509V3_CTX *ctx, int gen_type,
                               const char *value, int is_nc);

# ifdef HEADER_CONF_H
GENERAL_NAME *VR_v2i_GENERAL_NAME(const X509V3_EXT_METHOD *method,
                               X509V3_CTX *ctx, CONF_VALUE *cnf);
GENERAL_NAME *VR_v2i_GENERAL_NAME_ex(GENERAL_NAME *out,
                                  const X509V3_EXT_METHOD *method,
                                  X509V3_CTX *ctx, CONF_VALUE *cnf,
                                  int is_nc);
void VR_X509V3_conf_free(CONF_VALUE *val);
...
void VR_X509V3_set_ctx(X509V3_CTX *ctx, X509 *issuer, X509 *subject,
...
int VR_X509V3_add_value_int(const char *name, const ASN1_INTEGER *aint,
                         STACK_OF(CONF_VALUE) **extlist);
char *VR_i2s_ASN1_INTEGER(X509V3_EXT_METHOD *meth, const ASN1_INTEGER *aint);
ASN1_INTEGER *VR_s2i_ASN1_INTEGER(X509V3_EXT_METHOD *meth, const char *value);
char *VR_i2s_ASN1_ENUMERATED(X509V3_EXT_METHOD *meth, const ASN1_ENUMERATED *aint);
char *VR_i2s_ASN1_ENUMERATED_TABLE(X509V3_EXT_METHOD *meth,
...
# define hex_to_string VR_OPENSSL_buf2hexstr
# define string_to_hex VR_OPENSSL_hexstr2buf
#endif
...
int VR_X509V3_EXT_print_fp(FILE *out, X509_EXTENSION *ext, int flag, int indent);
#endif
int VR_X509V3_extensions_print(BIO *out, const char *title,
...
int VR_X509_PURPOSE_get_by_id(int id);
...
int VR_X509_PURPOSE_get_id(const X509_PURPOSE *);
...
void VR_X509_POLICY_NODE_print(BIO *out, X509_POLICY_NODE *node, int indent);
 ...
 */
int VR_X509v3_asid_add_inherit(ASIdentifiers *asid, int which);
int VR_X509v3_asid_add_id_or_range(ASIdentifiers *asid, int which,
                                ASN1_INTEGER *min, ASN1_INTEGER *max);
int VR_X509v3_addr_add_inherit(IPAddrBlocks *addr,
                            const unsigned afi, const unsigned *safi);
int VR_X509v3_addr_add_prefix(IPAddrBlocks *addr,
                           const unsigned afi, const unsigned *safi,
                           unsigned char *a, const int prefixlen);
int VR_X509v3_addr_add_range(IPAddrBlocks *addr,
                          const unsigned afi, const unsigned *safi,
                          unsigned char *min, unsigned char *max);
unsigned VR_X509v3_addr_get_afi(const IPAddressFamily *f);
int VR_X509v3_addr_get_range(IPAddressOrRange *aor, const unsigned afi,
                          unsigned char *min, unsigned char *max,
                          const int length);
 ...
 * Canonical forms.
 */
int VR_X509v3_asid_is_canonical(ASIdentifiers *asid);
int VR_X509v3_addr_is_canonical(IPAddrBlocks *addr);
int VR_X509v3_asid_canonize(ASIdentifiers *asid);
int VR_X509v3_addr_canonize(IPAddrBlocks *addr);

/*
 * Tests for inheritance and containment.
 */
int VR_X509v3_asid_inherits(ASIdentifiers *asid);
int VR_X509v3_addr_inherits(IPAddrBlocks *addr);
int VR_X509v3_asid_subset(ASIdentifiers *a, ASIdentifiers *b);
int VR_X509v3_addr_subset(IPAddrBlocks *a, IPAddrBlocks *b);

/*
 * Check whether RFC 3779 extensions nest properly in chains.
 */
int VR_X509v3_asid_validate_path(X509_STORE_CTX *);
int VR_X509v3_addr_validate_path(X509_STORE_CTX *);
int VR_X509v3_asid_validate_resource_set(STACK_OF(X509) *chain,
                                      ASIdentifiers *ext,
                                      int allow_inheritance);
int VR_X509v3_addr_validate_resource_set(STACK_OF(X509) *chain,
...
const ASN1_OBJECT *VR_NAMING_AUTHORITY_get0_authorityId(
    const NAMING_AUTHORITY *n);
const ASN1_IA5STRING *VR_NAMING_AUTHORITY_get0_authorityURL(
    const NAMING_AUTHORITY *n);
const ASN1_STRING *VR_NAMING_AUTHORITY_get0_authorityText(
    const NAMING_AUTHORITY *n);
void VR_NAMING_AUTHORITY_set0_authorityId(NAMING_AUTHORITY *n,
    ASN1_OBJECT* namingAuthorityId);
void VR_NAMING_AUTHORITY_set0_authorityURL(NAMING_AUTHORITY *n,
    ASN1_IA5STRING* namingAuthorityUrl);
void VR_NAMING_AUTHORITY_set0_authorityText(NAMING_AUTHORITY *n,
    ASN1_STRING* namingAuthorityText);

const GENERAL_NAME *VR_ADMISSION_SYNTAX_get0_admissionAuthority(
    const ADMISSION_SYNTAX *as);
void VR_ADMISSION_SYNTAX_set0_admissionAuthority(
    ADMISSION_SYNTAX *as, GENERAL_NAME *aa);
const STACK_OF(ADMISSIONS) *VR_ADMISSION_SYNTAX_get0_contentsOfAdmissions(
    const ADMISSION_SYNTAX *as);
void VR_ADMISSION_SYNTAX_set0_contentsOfAdmissions(
...
const ASN1_OCTET_STRING *VR_PROFESSION_INFO_get0_addProfessionInfo(
    const PROFESSION_INFO *pi);
void VR_PROFESSION_INFO_set0_addProfessionInfo(
    PROFESSION_INFO *pi, ASN1_OCTET_STRING *aos);
const NAMING_AUTHORITY *VR_PROFESSION_INFO_get0_namingAuthority(
    const PROFESSION_INFO *pi);
void VR_PROFESSION_INFO_set0_namingAuthority(
    PROFESSION_INFO *pi, NAMING_AUTHORITY *na);
const STACK_OF(ASN1_STRING) *VR_PROFESSION_INFO_get0_professionItems(
    const PROFESSION_INFO *pi);
void VR_PROFESSION_INFO_set0_professionItems(
    PROFESSION_INFO *pi, STACK_OF(ASN1_STRING) *as);
const STACK_OF(ASN1_OBJECT) *VR_PROFESSION_INFO_get0_professionOIDs(
    const PROFESSION_INFO *pi);
void VR_PROFESSION_INFO_set0_professionOIDs(
    PROFESSION_INFO *pi, STACK_OF(ASN1_OBJECT) *po);
const ASN1_PRINTABLESTRING *VR_PROFESSION_INFO_get0_registrationNumber(
    const PROFESSION_INFO *pi);
void VR_PROFESSION_INFO_set0_registrationNumber(
