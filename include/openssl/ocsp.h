...
#  define VR_d2i_OCSP_REQUEST_bio(bp,p) VR_ASN1_d2i_bio_of(OCSP_REQUEST,VR_OCSP_REQUEST_new,VR_d2i_OCSP_REQUEST,bp,p)

#  define VR_d2i_OCSP_RESPONSE_bio(bp,p) VR_ASN1_d2i_bio_of(OCSP_RESPONSE,VR_OCSP_RESPONSE_new,VR_d2i_OCSP_RESPONSE,bp,p)

#  define VR_PEM_read_bio_OCSP_REQUEST(bp,x,cb) (OCSP_REQUEST *)VR_PEM_ASN1_read_bio( \
     (char *(*)())VR_d2i_OCSP_REQUEST,PEM_STRING_OCSP_REQUEST, \
     bp,(char **)(x),cb,NULL)

#  define VR_PEM_read_bio_OCSP_RESPONSE(bp,x,cb)(OCSP_RESPONSE *)VR_PEM_ASN1_read_bio(\
     (char *(*)())VR_d2i_OCSP_RESPONSE,PEM_STRING_OCSP_RESPONSE, \
     bp,(char **)(x),cb,NULL)

#  define VR_PEM_write_bio_OCSP_REQUEST(bp,o) \
    VR_PEM_ASN1_write_bio((int (*)())VR_i2d_OCSP_REQUEST,PEM_STRING_OCSP_REQUEST,\
                        bp,(char *)(o), NULL,NULL,0,NULL,NULL)

#  define VR_PEM_write_bio_OCSP_RESPONSE(bp,o) \
    VR_PEM_ASN1_write_bio((int (*)())VR_i2d_OCSP_RESPONSE,PEM_STRING_OCSP_RESPONSE,\
                        bp,(char *)(o), NULL,NULL,0,NULL,NULL)

#  define VR_i2d_OCSP_RESPONSE_bio(bp,o) VR_ASN1_i2d_bio_of(OCSP_RESPONSE,VR_i2d_OCSP_RESPONSE,bp,o)

#  define VR_i2d_OCSP_REQUEST_bio(bp,o) VR_ASN1_i2d_bio_of(OCSP_REQUEST,VR_i2d_OCSP_REQUEST,bp,o)

#  define ASN1_BIT_STRING_digest(data,type,md,len) \
        VR_ASN1_item_digest(ASN1_ITEM_rptr(ASN1_BIT_STRING),type,data,md,len)

#  define OCSP_CERTSTATUS_dup(cs)\
                (OCSP_CERTSTATUS*)VR_ASN1_dup((int(*)())VR_i2d_OCSP_CERTSTATUS,\
                (char *(*)())VR_d2i_OCSP_CERTSTATUS,(char *)(cs))

OCSP_CERTID *VR_OCSP_CERTID_dup(OCSP_CERTID *id);
...
int VR_OCSP_REQ_CTX_i2d(OCSP_REQ_CTX *rctx, const ASN1_ITEM *it,
                     ASN1_VALUE *val);
int VR_OCSP_REQ_CTX_nbio_d2i(OCSP_REQ_CTX *rctx, ASN1_VALUE **pval,
                          const ASN1_ITEM *it);
...
OCSP_ONEREQ *VR_OCSP_request_add0_id(OCSP_REQUEST *req, OCSP_CERTID *cid);
...
int VR_OCSP_request_set1_name(OCSP_REQUEST *req, X509_NAME *nm);
int VR_OCSP_request_add1_cert(OCSP_REQUEST *req, X509 *cert);

int VR_OCSP_request_sign(OCSP_REQUEST *req,
                      X509 *signer,
                      EVP_PKEY *key,
                      const EVP_MD *dgst,
                      STACK_OF(X509) *certs, unsigned long flags);

int VR_OCSP_response_status(OCSP_RESPONSE *resp);
OCSP_BASICRESP *VR_OCSP_response_get1_basic(OCSP_RESPONSE *resp);

const ASN1_OCTET_STRING *VR_OCSP_resp_get0_signature(const OCSP_BASICRESP *bs);
const X509_ALGOR *VR_OCSP_resp_get0_tbs_sigalg(const OCSP_BASICRESP *bs);
const OCSP_RESPDATA *VR_OCSP_resp_get0_respdata(const OCSP_BASICRESP *bs);
int VR_OCSP_resp_get0_signer(OCSP_BASICRESP *bs, X509 **signer,
                          STACK_OF(X509) *extra_certs);

int VR_OCSP_resp_count(OCSP_BASICRESP *bs);
OCSP_SINGLERESP *VR_OCSP_resp_get0(OCSP_BASICRESP *bs, int idx);
const ASN1_GENERALIZEDTIME *VR_OCSP_resp_get0_produced_at(const OCSP_BASICRESP* bs);
const STACK_OF(X509) *VR_OCSP_resp_get0_certs(const OCSP_BASICRESP *bs);
int VR_OCSP_resp_get0_id(const OCSP_BASICRESP *bs,
                      const ASN1_OCTET_STRING **pid,
                      const X509_NAME **pname);
int VR_OCSP_resp_get1_id(const OCSP_BASICRESP *bs,
                      ASN1_OCTET_STRING **pid,
                      X509_NAME **pname);

int VR_OCSP_resp_find(OCSP_BASICRESP *bs, OCSP_CERTID *id, int last);
int VR_OCSP_single_get0_status(OCSP_SINGLERESP *single, int *reason,
                            ASN1_GENERALIZEDTIME **revtime,
                            ASN1_GENERALIZEDTIME **thisupd,
                            ASN1_GENERALIZEDTIME **nextupd);
int VR_OCSP_resp_find_status(OCSP_BASICRESP *bs, OCSP_CERTID *id, int *status,
                          int *reason,
                          ASN1_GENERALIZEDTIME **revtime,
                          ASN1_GENERALIZEDTIME **thisupd,
                          ASN1_GENERALIZEDTIME **nextupd);
int VR_OCSP_check_validity(ASN1_GENERALIZEDTIME *thisupd,
...
int VR_OCSP_request_onereq_count(OCSP_REQUEST *req);
OCSP_ONEREQ *VR_OCSP_request_onereq_get0(OCSP_REQUEST *req, int i);
OCSP_CERTID *VR_OCSP_onereq_get0_id(OCSP_ONEREQ *one);
int VR_OCSP_id_get0_info(ASN1_OCTET_STRING **piNameHash, ASN1_OBJECT **pmd,
                      ASN1_OCTET_STRING **pikeyHash,
                      ASN1_INTEGER **pserial, OCSP_CERTID *cid);
int VR_OCSP_request_is_signed(OCSP_REQUEST *req);
OCSP_RESPONSE *VR_OCSP_response_create(int status, OCSP_BASICRESP *bs);
OCSP_SINGLERESP *VR_OCSP_basic_add1_status(OCSP_BASICRESP *rsp,
                                        OCSP_CERTID *cid,
                                        int status, int reason,
                                        ASN1_TIME *revtime,
                                        ASN1_TIME *thisupd,
                                        ASN1_TIME *nextupd);
int VR_OCSP_basic_add1_cert(OCSP_BASICRESP *resp, X509 *cert);
int VR_OCSP_basic_sign(OCSP_BASICRESP *brsp,
                    X509 *signer, EVP_PKEY *key, const EVP_MD *dgst,
                    STACK_OF(X509) *certs, unsigned long flags);
int VR_OCSP_basic_sign_ctx(OCSP_BASICRESP *brsp,
                        X509 *signer, EVP_MD_CTX *ctx,
                        STACK_OF(X509) *certs, unsigned long flags);
int VR_OCSP_RESPID_set_by_name(OCSP_RESPID *respid, X509 *cert);
int VR_OCSP_RESPID_set_by_key(OCSP_RESPID *respid, X509 *cert);
int VR_OCSP_RESPID_match(OCSP_RESPID *respid, X509 *cert);
...
void *VR_OCSP_REQUEST_get1_ext_d2i(OCSP_REQUEST *x, int nid, int *crit,
                                int *idx);
...
int VR_OCSP_ONEREQ_get_ext_by_OBJ(OCSP_ONEREQ *x, const ASN1_OBJECT *obj, int lastpos);
...
const OCSP_CERTID *VR_OCSP_SINGLERESP_get0_id(const OCSP_SINGLERESP *x);
...
int VR_OCSP_REQUEST_print(BIO *bp, OCSP_REQUEST *a, unsigned long flags);
