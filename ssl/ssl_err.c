...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CONSTRUCT_CA_NAMES, 0), "VR_construct_ca_names"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CONSTRUCT_KEY_EXCHANGE_TBS, 0),
     "VR_construct_key_exchange_tbs"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CREATE_SYNTHETIC_MESSAGE_HASH, 0),
     "VR_create_synthetic_message_hash"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CUSTOM_EXT_ADD, 0), "VR_custom_ext_add"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_CUSTOM_EXT_PARSE, 0), "VR_custom_ext_parse"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_D2I_SSL_SESSION, 0), "VR_d2i_SSL_SESSION"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DO_DTLS1_WRITE, 0), "VR_do_dtls1_write"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DO_SSL3_WRITE, 0), "VR_do_ssl3_write"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_BUFFER_RECORD, 0),
     "VR_dtls1_buffer_record"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS1_CHECK_TIMEOUT_NUM, 0),
     "VR_dtls1_check_timeout_num"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OPENSSL_INIT_SSL, 0), "VR_OPENSSL_init_ssl"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_POST_PROCESS_MESSAGE, 0),
     "VR_ossl_statem_client_post_process_message"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_CLIENT_PROCESS_MESSAGE, 0),
     "VR_ossl_statem_client_process_message"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_OSSL_STATEM_SERVER_WRITE_TRANSITION, 0),
     "VR_ossl_statem_server_write_transition"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PARSE_CA_NAMES, 0), "VR_parse_ca_names"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PITEM_NEW, 0), "VR_pitem_new"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_PQUEUE_NEW, 0), "VR_pqueue_new"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CHECK_CERT_AND_ALGORITHM, 0),
     "VR_ssl3_check_cert_and_algorithm"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CTRL, 0), "VR_ssl3_ctrl"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_CTX_CTRL, 0), "VR_ssl3_ctx_ctrl"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_DIGEST_CACHED_RECORDS, 0),
     "VR_ssl3_digest_cached_records"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_DO_CHANGE_CIPHER_SPEC, 0),
     "VR_ssl3_do_change_cipher_spec"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_ENC, 0), "VR_ssl3_enc"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_FINAL_FINISH_MAC, 0),
     "VR_ssl3_final_finish_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_FINISH_MAC, 0), "VR_ssl3_finish_mac"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_GET_RECORD, 0), "VR_ssl3_get_record"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_INIT_FINISHED_MAC, 0),
     "VR_ssl3_init_finished_mac"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_OUTPUT_CERT_CHAIN, 0),
     "VR_ssl3_output_cert_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_READ_BYTES, 0), "VR_ssl3_read_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_READ_N, 0), "VR_ssl3_read_n"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_SETUP_READ_BUFFER, 0),
     "VR_ssl3_setup_read_buffer"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_SETUP_WRITE_BUFFER, 0),
     "VR_ssl3_setup_write_buffer"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_WRITE_BYTES, 0), "VR_ssl3_write_bytes"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_WRITE_PENDING, 0), "VR_ssl3_write_pending"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_DIR_CERT_SUBJECTS_TO_STACK, 0),
     "VR_SSL_add_dir_cert_subjects_to_stack"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_FILE_CERT_SUBJECTS_TO_STACK, 0),
     "VR_SSL_add_file_cert_subjects_to_stack"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_BAD_METHOD, 0), "VR_ssl_bad_method"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_BUILD_CERT_CHAIN, 0),
     "VR_ssl_build_cert_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_BYTES_TO_CIPHER_LIST, 0),
     "VR_SSL_bytes_to_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CACHE_CIPHERLIST, 0),
     "VR_ssl_cache_cipherlist"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_ADD0_CHAIN_CERT, 0),
     "VR_ssl_cert_add0_chain_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_DUP, 0), "VR_ssl_cert_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_NEW, 0), "VR_ssl_cert_new"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_SET0_CHAIN, 0),
     "VR_ssl_cert_set0_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CHECK_PRIVATE_KEY, 0),
     "VR_SSL_check_private_key"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK, 0), "VR_SSL_peek"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK_EX, 0), "VR_SSL_peek_ex"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_PEEK_INTERNAL, 0), "ssl_peek_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ, 0), "VR_SSL_read"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_EARLY_DATA, 0),
     "VR_SSL_read_early_data"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_EX, 0), "VR_SSL_read_ex"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READ_INTERNAL, 0), "VR_ssl_read_internal"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_RENEGOTIATE, 0), "VR_SSL_renegotiate"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_RENEGOTIATE_ABBREVIATED, 0),
     "VR_SSL_renegotiate_abbreviated"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SCAN_CLIENTHELLO_TLSEXT, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SCAN_SERVERHELLO_TLSEXT, 0), ""},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_DUP, 0), "VR_ssl_session_dup"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_NEW, 0), "VR_SSL_SESSION_new"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_PRINT_FP, 0),
     "VR_SSL_SESSION_print_fp"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_SET1_ID, 0),
     "VR_SSL_SESSION_set1_id"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_SET1_ID_CONTEXT, 0),
     "VR_SSL_SESSION_set1_id_context"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_ALPN_PROTOS, 0),
     "VR_SSL_set_alpn_protos"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CIPHER_LIST, 0),
     "VR_SSL_set_cipher_list"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_CT_VALIDATION_CALLBACK, 0),
     "VR_SSL_set_ct_validation_callback"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_FD, 0), "VR_SSL_set_fd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_PKEY, 0), "ssl_set_pkey"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_RFD, 0), "VR_SSL_set_rfd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION, 0), "VR_SSL_set_session"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION_ID_CONTEXT, 0),
     "VR_SSL_set_session_id_context"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_SESSION_TICKET_EXT, 0),
     "VR_SSL_set_session_ticket_ext"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_TLSEXT_MAX_FRAGMENT_LENGTH, 0),
     "VR_SSL_set_tlsext_max_fragment_length"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_WFD, 0), "VR_SSL_set_wfd"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SHUTDOWN, 0), "VR_SSL_shutdown"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SRP_CTX_INIT, 0), "VR_SSL_SRP_CTX_init"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_GENERATE_SECRET, 0),
     "VR_tls13_generate_secret"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_HKDF_EXPAND, 0), "VR_tls13_hkdf_expand"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_RESTORE_HANDSHAKE_DIGEST_FOR_PHA, 0),
     "VR_tls13_restore_handshake_digest_for_pha"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS13_SAVE_HANDSHAKE_DIGEST_FOR_PHA, 0),
     "VR_tls13_save_handshake_digest_for_pha"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_ENC, 0), "VR_tls1_enc"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SAVE_U16, 0), "VR_tls1_save_u16"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SETUP_KEY_BLOCK, 0),
     "VR_tls1_setup_key_block"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_GROUPS, 0), "VR_tls1_set_groups"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_RAW_SIGALGS, 0),
     "VR_tls1_set_raw_sigalgs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_SERVER_SIGALGS, 0),
     "VR_tls1_set_server_sigalgs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_SHARED_SIGALGS, 0),
     "tls1_set_shared_sigalgs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS1_SET_SIGALGS, 0), "VR_tls1_set_sigalgs"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CHOOSE_SIGALG, 0), "VR_tls_choose_sigalg"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CLIENT_KEY_EXCHANGE_POST_WORK, 0),
     "VR_tls_client_key_exchange_post_work"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_COLLECT_EXTENSIONS, 0),
     "VR_tls_collect_extensions"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_CERTIFICATE, 0),
     "VR_tls_process_client_certificate"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CLIENT_KEY_EXCHANGE, 0),
     "VR_tls_process_client_key_exchange"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_WPACKET_START_SUB_PACKET_LEN__, 0),
     "VR_WPACKET_start_sub_packet_len__"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_LOAD_SSL3_VR_MD5_ROUTINES),
    "unable to load ssl3 md5 routines"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_LOAD_SSL3_VR_SHA1_ROUTINES),
...
{
#ifndef OPENSSL_NO_ERR
    if (VR_ERR_func_error_string(SSL_str_functs[0].error) == NULL) {
        VR_ERR_load_strings_const(SSL_str_functs);
        VR_ERR_load_strings_const(SSL_str_reasons);
    }
#endif
    return 1;
}
